<?php /* Smarty version 2.6.18, created on 2014-11-13 16:48:06
         compiled from bbs/bbs_event_list.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'url', 'bbs/bbs_event_list.tpl', 37, false),)), $this); ?>
<script type="text/javascript" src="<?php echo @SITE; ?>
resource/js/bbs_list.js"></script>
<td valign="top" align="center">
 	<div class="main_ta_box">
         <div class="hd_t"><?php echo $this->_tpl_vars['event']['title']; ?>
活动留言</div>
...
resource/images/no_img.gif"><?php endif; ?></td>
                 ...
                 <td style="word-break:keep-all;">
                 	<?php if ($this->_tpl_vars['list'][$this->_sections['sec']['index']]['allow'] != 1): ?>
                 		<a class="pubBtn" href="<?php echo $this->_plugins['function']['url'][0][0]->_pi_func_url(array('controller' => 'Bbs','action' => 'Allow','type' => 'userEvent','id' => $this->_tpl_vars['list'][$this->_sections['sec']['index']]['id']), $this);?>
">通过</a>
                 	<?php else: ?>
                 		<a class="depubBtn" href="<?php echo $this->_plugins['function']['url'][0][0]->_pi_func_url(array('controller' => 'Bbs','action' => 'DeAllow','type' => 'userEvent','id' => $this->_tpl_vars['list'][$this->_sections['sec']['index']]['id']), $this);?>
">不通过</a>
                 	<?php endif; ?>
                 		<a class="delBtn" href="<?php echo $this->_plugins['function']['url'][0][0]->_pi_func_url(array('controller' => 'Bbs','action' => 'Del','type' => 'userEvent','id' => $this->_tpl_vars['list'][$this->_sections['sec']['index']]['id']), $this);?>
">删除</a>
                 </td>
             </tr>
             <?php endfor; endif; ?>
