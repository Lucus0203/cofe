<?php /* Smarty version 2.6.18, created on 2014-10-20 14:14:02
         compiled from publicEvent/public_event.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'url', 'publicEvent/public_event.tpl', 10, false),)), $this); ?>
...
<td valign="top" align="center">
 	<div class="main_ta_box">
         ...
         <div class="hd_t1">查找活动<input class="cz_input" type="text" name="title"><input class="cz_btn" type="submit" value="查找"></div>
         </form>
...
resource/images/no_img.gif"><?php endif; ?></td>
                 ...
                 <td><?php if ($this->_tpl_vars['list'][$this->_sections['sec']['index']]['ispublic'] == '2'): ?>未发布<?php else: ?>已发布<?php endif; ?></td>
...
">不发布<?php endif; ?></a>
         ...
         <p><input id="changeOrder" type="button" value="变更顺序" /></p>
