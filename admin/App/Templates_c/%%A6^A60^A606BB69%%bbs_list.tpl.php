<?php /* Smarty version 2.6.18, created on 2014-11-13 10:03:37
         compiled from bbs/bbs_list.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'url', 'bbs/bbs_list.tpl', 32, false),)), $this); ?>
...
留言</div>
         ...
         <input type="hidden" name="action" value="<?php echo $this->_tpl_vars['inputAct']; ?>
" />
         <div class="hd_t1">查找活动<input class="cz_input" type="text" name="keyword" value="<?php echo $this->_tpl_vars['keyword']; ?>
...
resource/images/no_img.gif"><?php endif; ?></td>
                 ...
                 <td style="word-break:keep-all;">
                 	<a href="<?php echo $this->_plugins['function']['url'][0][0]->_pi_func_url(array('controller' => 'Bbs','action' => 'Edit','type' => $this->_tpl_vars['inputAct'],'id' => $this->_tpl_vars['list'][$this->_sections['sec']['index']]['id']), $this);?>
">编辑</a><a class="delBtn" href="<?php echo $this->_plugins['function']['url'][0][0]->_pi_func_url(array('controller' => 'Bbs','action' => 'Del','type' => $this->_tpl_vars['inputAct'],'id' => $this->_tpl_vars['list'][$this->_sections['sec']['index']]['id']), $this);?>
">删除</a>
                 </td>
             </tr>
             <?php endfor; endif; ?>
