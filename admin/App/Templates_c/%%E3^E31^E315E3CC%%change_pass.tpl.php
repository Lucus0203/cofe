<?php /* Smarty version 2.6.18, created on 2014-10-29 15:22:53
         compiled from admin/change_pass.tpl */ ?>
<td valign="top" align="center">
 	<div class="main_ta_box">
         <div class="hd_t">修改管理员密码</div>
         <p style="text-align:left;margin-left:20px;color:red;"><?php echo $this->_tpl_vars['msg']; ?>
</p>
